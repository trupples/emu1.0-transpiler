...
r[31]=r[30]^32;
cond=r[31]==0;
CF {ip=jup(24586,cond,512,r[0]);break;}
r[1]=(r[0]+0)&63;
r[2]=(r[0]+0)&63;
r[3]=(r[0]+0)&63;
;case 24590://lbl5130
...
r[1]=(r[1]+1)&63;
cond=r[1]==0;
CF {ip=jup(24596,cond,513,r[0]);break;}
r[2]=(r[2]+1)&63;
cond=r[2]==0;
CF {ip=jup(24599,cond,513,r[0]);break;}
IO21(r[10]);
IO22(r[11]);
r[1]=(r[0]+63)&63;
IO23(r[1]);
...
r[34]=r[30]^4;
cond=r[31]==0;
CT {ip=jdn(24616,cond,515,r[0]);break;}
cond=r[32]==0;
CT {ip=jdn(24618,cond,516,r[0]);break;}
cond=r[33]==0;
CT {ip=jdn(24620,cond,517,r[0]);break;}
cond=r[34]==0;
CT {ip=jdn(24622,cond,518,r[0]);break;}
{ip=jup(24623,cond,514,r[0]);break;}
;case 24624://lbl5150
IO21(r[10]);
IO22(r[11]);
IO23(r[0]);
...
r[1]=(r[0]+63)&63;
IO23(r[1]);
{ip=jdn(24633,cond,519,r[0]);break;}
;case 24634://lbl5160
IO21(r[10]);
IO22(r[11]);
IO23(r[0]);
...
r[1]=(r[0]+63)&63;
IO23(r[1]);
{ip=jdn(24643,cond,519,r[0]);break;}
;case 24644://lbl5170
IO21(r[10]);
IO22(r[11]);
IO23(r[0]);
...
r[1]=(r[0]+63)&63;
IO23(r[1]);
{ip=jdn(24653,cond,519,r[0]);break;}
;case 24654://lbl5180
IO21(r[10]);
IO22(r[11]);
IO23(r[0]);
...
;case 24663://lbl5190
cond=r[10]==r[20];
CF {ip=jup(24665,cond,514,r[0]);break;}
cond=r[11]==r[21];
CF {ip=jup(24667,cond,514,r[0]);break;}
r[1]=(r[0]+0)&63;
IO21(r[1]);
r[1]=(r[0]+0)&63;
IO22(r[1]);
...
r[31]=r[30]^32;
cond=r[31]==0;
CF {ip=jup(49248,cond,667,r[0]);break;}
{ip=jup(49249,cond,666,r[0]);break;}
...
#define X_JUMP_TARGETS \
	X_JUMP_TARGET(1, 0, 666, 0)\
	X_JUMP_TARGET(24582, 0, 512, 0)\
	X_JUMP_TARGET(24590, 0, 513, 0)\
	X_JUMP_TARGET(24608, 0, 514, 0)\
	X_JUMP_TARGET(24624, 0, 515, 0)\
	X_JUMP_TARGET(24634, 0, 516, 0)\
	X_JUMP_TARGET(24644, 0, 517, 0)\
	X_JUMP_TARGET(24654, 0, 518, 0)\
	X_JUMP_TARGET(24663, 0, 519, 0)\
	X_JUMP_TARGET(49244, 0, 667, 0)
