...
r[2]=(r[2]+1)&63;
cond=r[2]==0;
CF {ip=jup(19459,cond,1,r[0]);break;}
r[1]=(r[1]+1)&63;
cond=r[1]==0;
CF {ip=jup(19462,cond,0,r[0]);break;}
r[3]=(r[0]+0)&63;
;case 19464://lbl20
r[2]=(r[0]+0)&63;
;case 19466://lbl40
...
r[1]=(r[1]+1)&63;
cond=r[1]==34;
CF {ip=jup(19477,cond,5,r[0]);break;}
r[2]=(r[2]+1)&63;
cond=r[2]==26;
CF {ip=jup(19480,cond,4,r[0]);break;}
r[5]=(r[0]+1)&63;
IO3(r[5]);
;case 19483://lbl30
r[5]=IO3(r[0]);
cond=r[5]<8;
CT {ip=jup(19486,cond,3,r[0]);break;}
r[3]=(r[3]+1)&63;
cond=r[3]==11;
CF {ip=jup(19489,cond,2,r[0]);break;}
r[3]=(r[0]+0)&63;
IO16(r[0]);
IO17(r[0]);
IO18(r[0]);
{ip=jup(19494,cond,2,r[0]);break;}
...
#define X_JUMP_TARGETS \
	X_JUMP_TARGET(19451, 0, 0, 0)\
	X_JUMP_TARGET(19454, 0, 1, 0)\
	X_JUMP_TARGET(19464, 0, 2, 0)\
	X_JUMP_TARGET(19466, 0, 4, 0)\
	X_JUMP_TARGET(19470, 0, 5, 0)\
	X_JUMP_TARGET(19483, 0, 3, 0)
