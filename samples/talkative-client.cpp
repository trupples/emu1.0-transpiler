...
r[1]=IO0(r[0]);
cond=r[1]<4;
CT {ip=jup(24,cond,512,r[0]);break;}
r[2]=(r[0]+14)&63;
r[10]=IO1(r[0]);
r[11]=IO1(r[0]);
r[12]=IO1(r[0]);
...
r[1]=IO1(r[0]);
cond=r[1]==62;
CF {ip=jup(33,cond,513,r[0]);break;}
;case 34://lbl5120
r[1]=IO0(r[0]);
cond=r[1]==0;
CT {ip=jdn(37,cond,513,r[0]);break;}
r[1]=IO1(r[0]);
if(((r[2]+0)&63)!=0)r[(r[2]+0)&63]=r[1];
r[2]=(r[2]+1)&63;
cond=r[1]!=62;
CF r[1]=(r[0]+36)&63;
CF r[1]=(r[0]+36)&63;
CF if(((r[2]+0)&63)!=0)r[(r[2]+0)&63]=r[1];
CT cond=r[2]<50;
CT {ip=jdn(46,cond,513,r[0]);break;}
r[3]=(r[0]+10)&63;
;case 48://lbl5140
r[1]=r[(r[3]+0)&63];
IO10(r[1]);
r[3]=(r[3]+1)&63;
cond=r[3]<r[2];
CT {ip=jup(53,cond,514,r[0]);break;}
r[1]=(r[0]+36)&63;
;case 55://lbl5140
cond=r[3]<50;
CF {ip=jdn(57,cond,514,r[0]);break;}
IO10(r[1]);
r[3]=(r[3]+1)&63;
{ip=jup(60,cond,514,r[0]);break;}
;case 61://lbl5140
r[2]=(r[0]+14)&63;
;case 63://lbl5130
r[1]=IO8(r[0]);
cond=r[1]==0;
CT {ip=jup(66,cond,512,r[0]);break;}
r[1]=IO9(r[0]);
IO2(r[1]);
{ip=jup(69,cond,513,r[0]);break;}
{ip=jup(70,cond,512,r[0]);break;}
...
#define X_JUMP_TARGETS \
	X_JUMP_TARGET(21, 0, 512, 0)\
	X_JUMP_TARGET(30, 0, 513, 0)\
	X_JUMP_TARGET(34, 0, 512, 0)\
	X_JUMP_TARGET(48, 0, 514, 0)\
	X_JUMP_TARGET(55, 0, 514, 0)\
	X_JUMP_TARGET(61, 0, 514, 0)\
	X_JUMP_TARGET(63, 0, 513, 0)
