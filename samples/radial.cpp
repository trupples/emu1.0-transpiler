...
r[3]=(r[1]+32)&63;
r[4]=(r[2]+32)&63;
r[3]=usgn((sgn(r[3])*sgn(r[3]))>>6);
r[4]=usgn((sgn(r[4])*sgn(r[4]))>>6);
r[3]=(r[3]+r[4])&63;
r[3]=(r[3]+1)&63;
;case 20://lbl5150
cond=r[3]>8;
CT r[3]=(r[3]+55)&63;
CT {ip=jup(23,cond,515,r[0]);break;}
r[3]=r[(r[3]+50)&63];
IO21(r[1]);
IO22(r[2]);
IO23(r[3]);
r[2]=(r[2]+1)&63;
cond=r[2]==0;
CF {ip=jup(30,cond,514,r[0]);break;}
r[1]=(r[1]+1)&63;
cond=r[1]==0;
...
#define X_JUMP_TARGETS \
	...
	X_JUMP_TARGET(13, 0, 514, 0)\
	X_JUMP_TARGET(20, 0, 515, 0)
